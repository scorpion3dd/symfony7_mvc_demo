...
/**
 * Class CreateFakerUserCommandTest - Unit tests for
 ...
 */
class CreateFakerUserCommandTest extends BaseCommandKernelTestCase
{
    /**
     * @return void
    ...
    /**
     * @testCase 1098 - Unit test for method execute create user async
